...
namespace Community.Data.Mapping
{
    ...
    public class CommunityEntityTypeConfiguration<TEntity> : ICommunityMappingConfiguration, IEntityTypeConfiguration<TEntity> where TEntity : CommunityBaseEntity
    {
        #region Utilities
